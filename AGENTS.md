...
- If no relevant doc exists, create one or add durable notes to the closest
  existing doc.
- Current dotfiles tickets live in GitHub Issues for `averagechris/dotfiles`:
  <https://github.com/averagechris/dotfiles/issues>. Use `gh issue` for the
  issue workflow.
...
- `docs/jj-pr-workflow.md`, `docs/bay.md`, `docs/jj-workspaces.md`, and `docs/jj-tag-workflow.md`
  - jj helper workflows.
