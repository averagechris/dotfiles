...
- [opencode patch lifecycle](/docs/opencode-patches.md) - Local upstream patches, validation, rationale, and removal criteria
...
- [srht](/docs/srht.md) - SourceHut CLI Home Manager module, project profiles, completions, OpenCode skills, and host enablement
