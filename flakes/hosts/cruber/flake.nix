{
  description = "Cruber NixOS system configuration";
  ...
  in {
    nixosConfigurations.cruber = mkHostWithModules ./configuration.nix;

    deploy.nodes.cruber = lib.mkDeploy' self.nixosConfigurations.cruber;
  };
}
