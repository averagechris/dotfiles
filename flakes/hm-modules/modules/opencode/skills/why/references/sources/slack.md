...
Slack and other chat tools vary. Check whether a Slack, Discord, Microsoft Teams, or Mattermost skill, CLI, or integration is available and inspect its instructions or help first. If authentication is unavailable, stop and report the gap; do not inspect credentials or secret material.
...
- **Auth failures.** If the integration isn't authenticated, stop. Don't make up findings. Report that chat wasn't searchable.
